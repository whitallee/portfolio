...
import whitPic from "../public/whit_pic.png";
    ...
    <main className="h-screen max-h-screen flex items-center overflow-hidden gap-4 pl-4 pr-4">
      <div className="flex flex-col gap-4">
        <div className="rounded-full overflow-hidden h-[150px] w-[150px] sm:h-[200px] sm:w-[200px]">
          <Image className="object-cover" src={whitPic} alt="Whit Allee-Milan, software engineer, programmer, coder" width={300} height={400} placeholder="blur" priority/>
        </div>
        <h1 className="text-3xl sm:text-6xl">Whit Allee-Milan</h1>
        <h2 className="text-xl sm:text-3xl">Full Stack Software Engineer<span className="animate-cursor-blink text-teal-800">|</span></h2>
