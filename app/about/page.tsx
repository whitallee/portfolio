import { Backpack, Bot, BrainCircuit, Briefcase, Computer, Cross, Dog, Laptop, ShoppingCart, Trophy, University, MonitorCog } from "lucide-react"
...
export default function Projects() {
    ...
    return (
        ...
        <div className="text-xl sm:text-2xl flex flex-col overflow-y-scroll pb-16">
            <p className="pr-2 sm:pr-16">My name is Whit Allee-Milan. I am a driven software engineer, self-taught, and highly motivated to grow and learn new things. If you&apos;d like to know about how I got here, feel free to scroll through my journey below.</p>
