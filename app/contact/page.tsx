  ...
  return (
    <main className="h-screen max-h-screen flex flex-col items-start justify-start w-full gap-4 pt-16">
        ...
        <div className="text-xl sm:text-2xl flex flex-col">
            ...
            <span className="indent-12 pb-4">email: <Link href="mailto:whitallee@gmail.com" className="text-teal-400 text-glow">whitallee@gmail.com</Link></span>
            ...
            <span className="indent-12 pb-4">linkedin: <Link href="https://www.linkedin.com/in/whit-allee-web-developer/" className="text-teal-400 text-glow">whit-allee-web-developer</Link></span>
